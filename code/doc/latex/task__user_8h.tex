...
\begin{DoxyCompactList}\small\item\em This task is used to create a user interface to communicate with. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Macros}
\begin{DoxyCompactItemize}
\item 
...
\item 11-\/29-\/2018 KM header for user control task created. \item 12-\/9-\/2018 KM last planned edit.\end{DoxyItemize}
