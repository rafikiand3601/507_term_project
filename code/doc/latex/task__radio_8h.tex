...
\begin{DoxyCompactList}\small\item\em This task is used to control the RF transciever. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item 11-\/29-\/2018 KM header for RF transciever task. \item 12-\/9-\/2018 KM last planned edit.\end{DoxyItemize}
