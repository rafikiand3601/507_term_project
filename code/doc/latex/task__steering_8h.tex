...
\begin{DoxyCompactList}\small\item\em This task is used to control the position of the servo. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item 11-\/29-\/2018 KM header for steering task created. \item 12-\/9-\/2018 KM last planned edit.\end{DoxyItemize}
